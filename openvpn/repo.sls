...
{%- if mapdata.external_repo_enabled == True and grains['os_family'] == "Debian" and grains['oscodename'] in mapdata.external_repo_supported %}
# Install openvpn external repository
# https://community.openvpn.net/openvpn/wiki/OpenvpnSoftwareRepos
openvpn_external_repo:
  pkgrepo.managed:
    - name: deb http://build.openvpn.net/debian/openvpn/{{ mapdata.external_repo_version }} {{ grains['oscodename'] }} main
